...
export const metadata: Metadata = {
  title: 'CI/CD Pipeline Visualizer | Rohit Darekar',
  description: 'Visualize your CI/CD pipelines. Upload GitHub Actions, GitLab CI, or Jenkins files and see the workflow in action.',
};
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-600 dark:text-gray-400">
                Visualize and simulate your deployment workflows
              </p>
            </div>
          </div>
        </div>
