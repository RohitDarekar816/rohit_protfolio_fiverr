...
export const metadata: Metadata = {
  title: 'Docker Compose Generator | Rohit Darekar',
  description: 'Generate production-ready docker-compose.yml files instantly. Select services, customize configurations, and deploy with confidence.',
};
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-600 dark:text-gray-400">
                Build production-ready configurations in seconds
              </p>
            </div>
          </div>
        </div>
