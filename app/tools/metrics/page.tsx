...
export const metadata: Metadata = {
  title: 'Live Metrics Dashboard | Rohit Darekar',
  description: 'Real-time monitoring dashboard showcasing observability expertise. Watch CPU, memory, disk, and network metrics update live.',
};
