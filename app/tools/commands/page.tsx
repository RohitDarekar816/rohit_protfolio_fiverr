...
export const metadata: Metadata = {
  title: 'Command Cheat Sheet | Rohit Darekar',
  description: 'Searchable collection of essential DevOps commands. Copy, save favorites, and boost your productivity with Docker, Kubernetes, Git, Linux, and AWS CLI commands.',
};
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-slate-600 dark:text-gray-400">
                Essential DevOps commands at your fingertips
              </p>
            </div>
          </div>
        </div>
